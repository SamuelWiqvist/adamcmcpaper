...
pintln(size(theta_training))

theta_test = theta_training[:,end-length_test_data+1:end]
loglik_test = loglik_training[end-length_test_data+1:end]

println(size(theta_test))

theta_training = theta_training[:,burn_in+1:length_training_data]
loglik_training = loglik_training[burn_in+1:length_training_data]

println(size(theta_training))
