...
load('est5_PMCMC_N_2000.mat')% some saved matlab workspace

Theta_mcwm = Theta;
burn_in_pmcmc = burn_in;


load('pmcmc_est2_R5000_May_29_17.mat')% some saved matlab workspace

Theta_da = Theta;
burn_in_da = burn_in;


load('ergp_R5000_25_direct_May_29')% some saved matlab workspace
