...
# nbr iterations
nbr_iterations = 10 # should be 20000
...
# type of job
job = "simdata" # ARGS[1] # set work to simdata or new_data
...
# save results
#writetable("alg_prop_da_*ARGS[2]*.csv", convert(DataFrame, alg_prop_da))
#writetable("alg_prop_ada_*ARGS[2]*.csv", convert(DataFrame, alg_prop_ada))
