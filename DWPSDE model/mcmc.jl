      ...
      if !accept_gp
        ...
        if dist_type == "Normal" # uniform priors
          ...
          if alg == "MCWM"
            ...
            a_log = (loglik_star + loglik_gp_old)  -  (pf_paralell(Z, Theta[:,r-1],theta_known,N,dt,dt_U,nbr_x0, nbr_x,subsample_interval,false,false, nbr_of_proc, loglik_vec) + loglik_gp_new)
          else
